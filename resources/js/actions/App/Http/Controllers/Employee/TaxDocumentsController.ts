...
/**
* @see \App\Http\Controllers\Employee\TaxDocumentsController::index
...
const TaxDocumentsController = { index, payeCertificate, pensionStatement }

export default TaxDocumentsController
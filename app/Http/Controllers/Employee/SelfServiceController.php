    ...
    public function payslip(PayrollRun $payrollRun): Response
    {
        ...
        return Inertia::render('employee/payslip', [
            ...
            'calculation' => [
                ...
                'otherAllowance1' => $employeeCalc['other_allowance_1'] ?? 0,
                'otherAllowance2' => $employeeCalc['other_allowance_2'] ?? 0,
                'totalEarnings' => $employeeCalc['total_earnings'] ?? 0,
                'totalDeductions' => $employeeCalc['total_deductions'] ?? 0,
                'netPay' => $employeeCalc['net_pay'] ?? 0,
                'paye' => $employeeCalc['paye_deduction'] ?? 0,
                'pensionDeduction' => $employeeCalc['pension_deduction'] ?? 0,
                'pensionEmployer' => $employeeCalc['pension_employer'] ?? 0,
                'nhf' => $employeeCalc['nhf_deduction'] ?? 0,
                'nhisDeduction' => $employeeCalc['nhis_deduction'] ?? 0,
                'nhisEmployer' => $employeeCalc['nhis_employer'] ?? 0,
                'nsitf' => $employeeCalc['nsitf_deduction'] ?? 0,
